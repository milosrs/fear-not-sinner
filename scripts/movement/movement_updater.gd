...
var _transitions: Dictionary[Array, Movement] = {
	[States.MoveState.IDLE, States.MoveState.WALK]:             
		Movement.new("walk_curve", 0.1, 1.0),
	[States.MoveState.WALK, States.MoveState.IDLE]:             
		Movement.new("walk_stop_curve", -1.0, 1.0),
	[States.MoveState.WALK, States.MoveState.SPRINT]:           
		Movement.new("walk_sprint_curve", -1.0, 1.0),
	[States.MoveState.SPRINT, States.MoveState.WALK]:           
		Movement.new("sprint_walk_curve", -1.0, 1.0),
	[States.MoveState.SPRINT, States.MoveState.IDLE]:           
		Movement.new("sprint_stop_curve", -1.0, 1.0),
	[States.MoveState.JUMP, States.MoveState.IDLE]:             
		Movement.new("", 0.1, 1.0, true, 0.0),
	[States.MoveState.ROLL, States.MoveState.IDLE]:             
		Movement.new("", 0.1, 1.0, true, 0.0),
	[States.MoveState.CROUCH, States.MoveState.WALK_CROUCH]:    
		Movement.new("walk_curve", 0.05, 0.45),
	[States.MoveState.CROUCH, States.MoveState.WALK]:           
		Movement.new("walk_curve", 0.05, 1.0),
	[States.MoveState.IDLE, States.MoveState.WALK_CROUCH]:      
		Movement.new("walk_curve", 0.05, 0.45),
	[States.MoveState.WALK, States.MoveState.WALK_CROUCH]:      
		Movement.new("walk_curve", 0.05, 0.45),
	[States.MoveState.WALK_CROUCH, States.MoveState.WALK]:      
		Movement.new("walk_curve", 0.05, 1.0),
	[States.MoveState.WALK_CROUCH, States.MoveState.IDLE]:      
		Movement.new("walk_stop_curve", -1.0, 0.5),
	[States.MoveState.IDLE, States.MoveState.ROLL]:             
		Movement.new("roll_curve", -1.0, 1.0),
	[States.MoveState.WALK, States.MoveState.ROLL]:             
		Movement.new("roll_curve", -1.0, 1.0),
	[States.MoveState.SPRINT, States.MoveState.ROLL]:           
		Movement.new("roll_curve", -1.0, 1.0),
	[States.MoveState.WALK_CROUCH, States.MoveState.ROLL]:      
		Movement.new("roll_curve", -1.0, 1.0),
	[States.MoveState.CROUCH, States.MoveState.ROLL]:           
		Movement.new("roll_curve", -1.0, 1.0),
}
...
func move(
	...
	if to_state == States.MoveState.ROLL and fsm.current == States.MoveState.ROLL:
		return
